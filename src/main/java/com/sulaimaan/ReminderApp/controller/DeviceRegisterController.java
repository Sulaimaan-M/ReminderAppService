...
public class DeviceRegisterController {
    ...
    @PostMapping
    public DeviceToken registerDeviceToken( @RequestBody Map<String, String> fcmToken) {

        System.out.println("📥 Registering device token : "+fcmToken.get("fcmToken"));
        return deviceTokenService.registerDevice(fcmToken.get("fcmToken"));
    }
}
